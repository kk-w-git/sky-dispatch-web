...
const customConfig: Linter.Config[] = [
  ...
  {
    // @core/shared内部组件，不能引入@mamba/* 或者 @mamba-core/* 里面的包
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            {
              group: ['@mamba/*', '@mamba-core/*'],
              message:
                'The @mamba-core/shared package cannot import the @vben package, please use the @core/shared package itself',
            },
          ],
        },
      ],
