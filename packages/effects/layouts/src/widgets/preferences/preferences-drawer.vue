...
import type { SegmentedItem } from '@mamba-core/shadcn-ui';

import { computed, ref } from 'vue';

import { Copy, Pin, PinOff, RotateCw } from '@mamba/icons';
import { $t, loadLocaleMessages } from '@mamba/locales';
import {
  clearCache,
  preferences,
  resetPreferences,
...
import { useVbenDrawer } from '@mamba-core/popup-ui';
import {
  VbenButton,
  VbenIconButton,
  VbenSegmented,
} from '@mamba-core/shadcn-ui';
import { globalShareState } from '@mamba-core/shared/global-state';
