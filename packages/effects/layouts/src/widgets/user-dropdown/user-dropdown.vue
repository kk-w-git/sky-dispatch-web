...
import type { AnyFunction } from '@mamba/types';

import { computed, useTemplateRef, watch } from 'vue';

import { useHoverToggle } from '@mamba/hooks';
import { LockKeyhole, LogOut } from '@mamba/icons';
import { $t } from '@mamba/locales';
import { preferences, usePreferences } from '@mamba/preferences';
import { useAccessStore } from '@mamba/stores';
import { isWindowsOs } from '@mamba/utils';

import { useVbenModal } from '@mamba-core/popup-ui';
import {
  Badge,
  DropdownMenu,
  DropdownMenuContent,
