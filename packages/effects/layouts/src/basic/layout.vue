...
import type { MenuRecordRaw } from '@mamba/types';

import { computed, onMounted, useSlots, watch } from 'vue';
import { useRoute } from 'vue-router';

import { useRefresh } from '@mamba/hooks';
import { $t, i18n } from '@mamba/locales';
import {
  preferences,
  updatePreferences,
  usePreferences,
...
import { cloneDeep, mapTree } from '@mamba/utils';

import { VbenAdminLayout } from '@mamba-core/layout-ui';
import { VbenBackTop, VbenLogo } from '@mamba-core/shadcn-ui';
