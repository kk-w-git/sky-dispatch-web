...
import type { TabDefinition } from '@mamba/types';

import type { IContextMenuItem } from '@mamba-core/tabs-ui';

import { computed, ref, watch } from 'vue';
import { useRoute, useRouter } from 'vue-router';

import { useContentMaximize, useTabs } from '@mamba/hooks';
import {
  ArrowLeftToLine,
  ArrowRightLeft,
  ArrowRightToLine,
...
import { $t, useI18n } from '@mamba/locales';
import { getTabKey, useAccessStore, useTabbarStore } from '@mamba/stores';
import { filterTree } from '@mamba/utils';
