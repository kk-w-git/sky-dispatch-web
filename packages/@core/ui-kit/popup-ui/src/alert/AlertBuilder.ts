...
import type { Recordable } from '@mamba-core/typings';

import type { AlertProps, BeforeCloseScope, PromptProps } from './alert';

import { h, nextTick, ref, render } from 'vue';

import { useSimpleLocale } from '@mamba-core/composables';
import { Input, VbenRenderContent } from '@mamba-core/shadcn-ui';
import { isFunction, isString } from '@mamba-core/shared/utils';
