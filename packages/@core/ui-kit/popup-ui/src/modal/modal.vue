...
import {
  ...
  usePriorityValues,
  useSimpleLocale,
} from '@mamba-core/composables';
import { Expand, Shrink } from '@mamba-core/icons';
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
import { ELEMENT_ID_MAIN_CONTENT } from '@mamba-core/shared/constants';
import { globalShareState } from '@mamba-core/shared/global-state';
import { cn } from '@mamba-core/shared/utils';
