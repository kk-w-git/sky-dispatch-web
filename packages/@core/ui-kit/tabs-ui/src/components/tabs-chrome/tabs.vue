...
import type { TabDefinition } from '@mamba-core/typings';

import type { TabConfig, TabsProps } from '../../types';

import { computed, ref } from 'vue';

import { Pin, X } from '@mamba-core/icons';
import { VbenContextMenu, VbenIcon } from '@mamba-core/shadcn-ui';
...
<style scoped>
@reference "@mamba/tailwind-config/theme";
