...
import { useForwardPropsEmits } from '@mamba-core/composables';
import { ChevronsLeft, ChevronsRight } from '@mamba-core/icons';
import { VbenScrollbar } from '@mamba-core/shadcn-ui';
